...
The goal here is to determine whether or not the order of inclusion of covariates into the DFA model affects the estimation of their true effect size. I will create two of them: a linear trend and cyclical period.
